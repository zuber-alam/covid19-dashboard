...
export default class WorldMap extends React.Component {
	...
	update() {
		axios.get('https://corona.lmao.ninja/countries')
			...
			var dataset = {};
			this.arrDataValues = this.objData.map(item => {
				return item.cases;
			});
		const minValue = Math.min.apply(null, this.arrDataValues),
		maxValue = Math.max.apply(null, this.arrDataValues);
	...
	render() {
		return (
			<Home additionalClasses="ResponsiveMap">
				<Datamap
					scope="world"
